const express = require("express"),
  ...
  { checkDatabaseActive } = require("./utils");

// validate the user credentials
router.post("/auth/signin", async function (req, res) {
  try {
    const databaseIsActive = await checkDatabaseActive();
    console.log("database is active: " + databaseIsActive);
